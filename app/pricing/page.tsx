    ...
    <div style={{ paddingTop: "64px" }}>
      <section style={{ position: "relative", padding: "140px 32px 100px", background: "#000", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "900px", margin: "0 auto", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontFamily: "'Shippori Mincho', sans-serif", fontSize: "15px", lineHeight: 2.0, letterSpacing: "0.04em", color: "rgba(255,255,255,0.42)", maxWidth: "500px" }}>
      ...
      <section style={{ padding: "100px 32px", background: "#000" }}>
          ...
          {plans.map((p) => (
            <div key={p.en} style={{ background: p.highlight ? "rgba(122,88,166,0.08)" : "rgba(255,255,255,0.02)", border: p.highlight ? "0.5px solid rgba(122,88,166,0.3)" : "0.5px solid rgba(255,255,255,0.07)", borderRadius: "12px", padding: "36px 28px", position: "relative", overflow: "hidden", display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div>
                ...
                <h3 style={{ fontFamily: "'Shippori Mincho', sans-serif", fontSize: "18px", fontWeight: 700, letterSpacing: "0.04em", marginBottom: "16px" }}>{p.title}</h3>
                ...
                {p.period && <p style={{ fontFamily: "'Shippori Mincho', sans-serif", fontSize: "11px", color: "rgba(255,255,255,0.3)" }}>{p.period}</p>}
              </div>
              <p style={{ fontFamily: "'Shippori Mincho', sans-serif", fontSize: "13px", lineHeight: 2.0, letterSpacing: "0.04em", color: "rgba(255,255,255,0.4)", flex: 1 }}>{p.desc}</p>
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "10px" }}>
                {p.features.map((f) => (
                  <li key={f} style={{ display: "flex", alignItems: "center", gap: "10px", fontFamily: "'Shippori Mincho', sans-serif", fontSize: "13px", color: "rgba(255,255,255,0.45)" }}>
        ...
        <p style={{ textAlign: "center", fontFamily: "'Shippori Mincho', sans-serif", fontSize: "13px", letterSpacing: "0.04em", color: "rgba(255,255,255,0.25)", marginTop: "40px" }}>
